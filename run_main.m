...
% Last Modified by GUIDE v2.5 10-Sep-2017 00:28:35
...
% eventdata  reserved - to be defined in a future version of MATLAB
% handles    structure with handles and user data (see GUIDATA)
[fname, path] = uigetfile({'*.mp4';'*.webm';'*.*'}, 'Select the video to check');
split = strsplit(fname, '.');
filename = split{1};
ext = strcat('.', split{2});

total = strcat(strcat(path, filename), ext);
set(handles.text2, 'String', total);
...
% --- Executes on button press in btncgfolder.
function btncgfolder_Callback(hObject, eventdata, handles)
% hObject    handle to btncgfolder (see GCBO)
% eventdata  reserved - to be defined in a future version of MATLAB
% handles    structure with handles and user data (see GUIDATA)
cg_folder = uigetdir;
set(handles.cgfolder, 'String', cg_folder);
handles.cg_folder = cg_folder;
guidata(hObject,handles)

% --- Executes on button press in btnnatfolder.
function btnnatfolder_Callback(hObject, eventdata, handles)
% hObject    handle to btnnatfolder (see GCBO)
% eventdata  reserved - to be defined in a future version of MATLAB
% handles    structure with handles and user data (see GUIDATA)
nat_folder = uigetdir;
set(handles.natfolder, 'String', nat_folder);
handles.nat_folder = nat_folder;
guidata(hObject,handles)

% --- Executes on button press in runtraining.
function runtraining_Callback(hObject, eventdata, handles)
% hObject    handle to runtraining (see GCBO)
% eventdata  reserved - to be defined in a future version of MATLAB
% handles    structure with handles and user data (see GUIDATA)
...
function natfolder_Callback(hObject, eventdata, handles)
% hObject    handle to natfolder (see GCBO)
% eventdata  reserved - to be defined in a future version of MATLAB
% handles    structure with handles and user data (see GUIDATA)

% Hints: get(hObject,'String') returns contents of natfolder as text
%        str2double(get(hObject,'String')) returns contents of natfolder as a double


% --- Executes during object creation, after setting all properties.
function natfolder_CreateFcn(hObject, eventdata, handles)
% hObject    handle to natfolder (see GCBO)
% eventdata  reserved - to be defined in a future version of MATLAB
% handles    empty - handles not created until after all CreateFcns called
...
function cgfolder_Callback(hObject, eventdata, handles)
% hObject    handle to cgfolder (see GCBO)
% eventdata  reserved - to be defined in a future version of MATLAB
% handles    structure with handles and user data (see GUIDATA)

% Hints: get(hObject,'String') returns contents of cgfolder as text
%        str2double(get(hObject,'String')) returns contents of cgfolder as a double


% --- Executes during object creation, after setting all properties.
function cgfolder_CreateFcn(hObject, eventdata, handles)
% hObject    handle to cgfolder (see GCBO)
% eventdata  reserved - to be defined in a future version of MATLAB
% handles    empty - handles not created until after all CreateFcns called
